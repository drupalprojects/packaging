...
/**
 * @file
 * Contains \Drupal\packaging\Plugin\Strategy\PackageAllInOne.
 *
 ...
 *
 * @Strategy(
 *   id = "packaging_allinone",
 *   admin_label = @Translation("All-in-one (first fit)", context = "Packaging")
 * )
 */
class PackageAllInOne implements Strategy {
